    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        <View style={styles.card}>
          ...
          <Text style={styles.proposalTitle}>Yeni Kütüphane Çalışma Alanları Oluşturulması</Text>
          <Text style={styles.proposalDescription}>Üniversite kütüphanemizde ek çalışma alanları oluşturulup oluşturulmaması konusunda öğrencilerimizin görüşlerini almak istiyoruz. Bu yeni alanlar, sessiz çalışma bölümleri veya grup çalışma odaları şeklinde düzenlenebilir.</Text>
        </View>

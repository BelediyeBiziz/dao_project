    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        <View style={styles.card}>
          ...
          <Text style={styles.proposalTitle}>Kampüs İçi Ulaşım Saatlerinin Yeniden Düzenlenmesi</Text>
          <Text style={styles.proposalDescription}>Öğrenci ve akademik personelin kampüs içi ulaşım ihtiyaçlarını daha iyi karşılamak için servis saatlerinde değişiklik yapılması teklif edilmektedir. Bu teklif, mevcut saatlerin yeterliliğini ve yeni önerilen saat aralıklarını içermektedir.</Text>
        </View>
